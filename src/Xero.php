...
use AdminUI\AdminUIXero\Resources\Contacts;
use AdminUI\AdminUIXero\Resources\Invoices;
use AdminUI\AdminUIXero\Resources\Payments;
use AdminUI\AdminUIXero\Resources\Webhooks;
...
class Xero
{
    ...
    protected static function dopost($url, $params)
    {
        try {
            ...
            return json_decode($e->response->getBody()->getContents(), true);
        }
    }
}
